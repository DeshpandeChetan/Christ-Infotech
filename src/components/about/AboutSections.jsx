...
export function WhoWeAre() {
  return <section className="section-space"><div className="container"><SectionHeading eyebrow="Who we are" title={<>Turning Business Ideas into<br className="d-none d-md-block" /> Practical Technology</>} /><div className="row align-items-center g-5"><div className="col-lg-5"><div className="who-copy"><p>Christ Infotech is a technology and innovation centre focused on building practical software solutions for businesses and institutions. We work with organizations to develop applications, intelligent systems, and data-driven platforms that improve efficiency and support digital growth.</p><p>Alongside industry projects, the centre also contributes to the technology needs of CHRIST (Deemed to be University) while providing opportunities for students and faculty to engage in real-world software development, research, and emerging technologies such as Artificial Intelligence and Data Analytics.</p><p>Through this collaborative environment, Christ Infotech connects industry requirements, academic expertise, and innovation to deliver meaningful technology solutions.</p></div></div><div className="col-lg-5 offset-lg-1"><img className="rounded-media who-image" src={warmImage} alt="Demo team discussion placeholder" /></div></div></div></section>
}
