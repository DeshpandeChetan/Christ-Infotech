...
export const deliverySteps = [
  { number: '01', title: 'Understand', text: 'We begin by understanding the client’s goals, challenges, and requirements to identify the most suitable technology approach.', image: howWeWorks1 },
  { number: '02', title: 'Develop', text: 'Our team designs and builds practical technology solutions tailored to the client’s needs.', image: howWeWork2 },
  { number: '03', title: 'Deliver & Support', text: 'We deploy the solution smoothly and continue to provide support to ensure it performs reliably as the organization grows.', image: howWeWorks1 },
]
